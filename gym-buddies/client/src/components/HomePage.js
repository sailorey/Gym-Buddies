  ...
  return (
    <div className="homepage container">
      ...
      <div className="home-images">
        <a href="/workout/664b82550f7dd84976375d3e">
        ...
        <a href="/workout/664baedc37a92aa6417044cd">
          <div className="workout">
        ...
        <a href="/workout/664bb015a0253e00ae4fc7f7">
          <div className="workout">
            <h3>Abs Workout</h3>
        ...
        <a href="/workout/664bb0e195644a8a1b75eca9">
          <div className="workout">
            <h3>Arms Workout</h3>
